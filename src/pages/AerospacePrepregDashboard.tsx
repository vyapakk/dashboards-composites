...
const AerospacePrepregDashboard = () => {
  ...
  const getSegmentInfo = () => {
    switch (activeTab) {
      ...
      default: return { data: marketData.aircraftType, title: "Resin Type" };
    }
  };
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <MainNavigation
            ...
            onYearChange={setSelectedYear}
            showYearSelector
            tabs={aerospacePrepregTabs}
            years={aerospacePrepregYears}
          />
        </div>
        ...
        <motion.footer initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }} className="mt-12 border-t border-border pt-6">
          <div className="flex flex-col items-center justify-between gap-4 text-center md:flex-row md:text-left">
            <div>
              <p className="text-sm text-muted-foreground">A&D Thermoplastic Prepreg Market Research Report</p>
