...
const CabinCompositesDashboard = () => {
  ...
  const getSegmentInfo = () => {
    switch (activeTab) {
      case "endUser": return { data: marketData.endUser, title: "Sales Channel" };
      ...
      case "equipment": return { data: marketData.furnishedEquipment, title: "Composites Type" };
      case "process": return { data: marketData.processType || [], title: "Process Type" };
      default: return { data: marketData.endUser, title: "Sales Channel" };
    }
  };
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <motion.footer initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }} className="mt-12 border-t border-border pt-6">
          <div className="flex flex-col items-center justify-between gap-4 text-center md:flex-row md:text-left">
            <div>
              <p className="text-sm text-muted-foreground">Aircraft Cabin Interior Composites Market Research Report</p>
